        ...
        {foreach from=$list item=item}
            <div class="p-stock__item">
                <a class="js-modal" href="#stockDescription{$item.id}">
                    <img class="p-stock__img" src="/photos/145x195.png" onload="img.load(this)" link="{$item.img[0]|img:"145x195x3"}"/>
                </a>
                        ...
                        <div class="p_stock__modal-img-list">
                            {foreach from=$item.img item=img}
                                <a href="{$img|img:"0x0x2"}" class="js-modal">
                                    <img class="p-stock__modal-img" src="/photos/250x400.png" link="{$img|img:"250x400x3"}"/>
                                </a>
                            {/foreach}
                        </div>
